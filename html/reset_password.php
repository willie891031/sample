...
?>
    ...
    <body>
		...
		<br><br><br><br><br><br>
		<div style="padding-left:625px;padding-top:50px;align:center">
	    <a href="login.php"><img src="img/back.png" height=75 align='left'></a>
		<table width="510" height="80">
　			<tr><td align="center"><font color="black" size='7'>重設密碼</font></td></tr>
		</table>
		</div>
			<form method='POST' action='123.php'>
				<br><br>
				<center>
				<input type='text' name='account' placeholder="E-Mail" style="font-size:30px"><br><br>
				<input type='submit' name='send' value='下一個' style="width:350px;height:40px;background-color:#CA8EFF;color:#FFFFFF;font-size:26px">
				</center><br>
			</form>
